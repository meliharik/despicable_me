...
import 'package:despicableme/pages/character_detail_screen.dart';
...
class CharacterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        Navigator.push(context, PageRouteBuilder(transitionDuration: const Duration(milliseconds: 350),
